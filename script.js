...
initScene = () => {
    ...
    // LIGHTS
    var light = new THREE.HemisphereLight(0xe6e6e6, 0x080820, 1);
    ...
    var ground_texture = loader.load('/images/ny.jpg', function (texture) {
    ...
    var light = new THREE.DirectionalLight( 0xCC, 1,500 );
    scene.add( light );
    ...
    createCar = () => {
        car_material = Physijs.createMaterial(
            new THREE.MeshLambertMaterial({ color: 0x165687 }),
            0.8,
            0.2
        );
    ...
    checkCarPosition = () => {
        if (car.body.position.y < 0) {
            ...
            readDisclaimer.innerHTML = 'TRY AGAIN';
            setTimeout(function () {
